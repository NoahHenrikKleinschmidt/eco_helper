...
It requires a _pickle file_ containing an `EnrichmentCollection` object. This can be generated by passing the ``--pickle`` option to the `eco_helper enrich` command.
